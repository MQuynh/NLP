...
no_recommended = data[data['Recommended IND'] == 0]

undersampled_recommended = resample(recommended, 
                                    replace=False,  
                                    n_samples=len(no_recommended), 
                                    random_state=42) 
data = pd.concat([undersampled_recommended, no_recommended])
